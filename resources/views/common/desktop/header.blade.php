    ...
    <ul class="topnav">
        ...
        <!--<li class="dropdown member"><a href="#">บัญชีของฉัน</a>
          <ul class="drop-nav">
            ...
            <li><a href="myaddress.php">ข้อมูลสถานที่จัดส่ง</a></li>
            <li><a href="myhistory.php">ประวัติการสั่งซื้อ</a></li>
            <li><a href="mywishlist.php">สินค้าที่น่าสนใจ</a></li>
        ...
        <li class="cart"><div id="dd" class="shopping-dropdown">
           ...
           <ul class="dropdown shopping-list">
             ...
             <li>
             <a href="cart.php" class="btn-process">ดูตะกร้าสินค้า</a>
             </li>
           </ul>
        </div></li>
      </ul>
