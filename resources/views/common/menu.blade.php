  ...
  <div class="sidebar-nav navbar-collapse slimscrollsidebar">
    <div class="user-profile">
      <div class="dropdown user-pro-body">
        ...
        <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Steave Gection <span class="caret"></span>
        </a>
      ...
      <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
          ...
          <li>
              <div class="hide-menu t-earning">
                  <div id="sparkline2dash" class="m-b-10"></div><small class="db">TOTAL EARNINGS - JUNE 2016</small>
          ...
          <li> <a href="javascript: void(0);" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu"> Real Estate <span class="fa arrow"></span> <span class="label label-rouded label-custom pull-right">New</span></span></a>
              <ul class="nav nav-second-level">
                  <li> <a href="real-estate-dashboard.html">Dashboard</a> </li>
                  <li> <a href="property-list.html">Property List</a> </li>
                  <li> <a href="property-3-column.html">Property 3 Column</a> </li>
                  <li> <a href="property-4-column.html">Property 4 Column</a> </li>
                  <li> <a href="property-detail.html">Property Details</a> </li>
