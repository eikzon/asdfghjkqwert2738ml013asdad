                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            ...
                            <form role="form">
                                ...
                                <button type="submit" class="btn btn-inverse"><i class="fa fa-search m-r-5"></i>Search</button>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <div class="white-box p-0 pro-box pro-horizontal">
                            <div class="col-sm-4 pro-list-img" style="background: url('../plugins/images/property/prop4.jpeg') center center / cover no-repeat;"> <span class="pro-label label label-inverse">For Rent</span> </div>
                            <div class="col-sm-8">
                                <div class="pro-content">
                                    <div class="pro-list-details col-sm-6">
                                        ...
                                        <h4 class="text-danger">&#36; 220,000</h4> </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="pro-agent">
                                            ...
                                            <div class="agent-name">
                                                <h5 class="m-b-0">Jon Doe</h5> <small class="text-muted">5 Property</small> </div>
                                        </div>
                                        <div class="pro-location hidden-xs hidden-xs hidden-xs"> <span class="pull-right text-muted"><i class="fa fa-map-marker text-danger m-r-10" aria-hidden="true"></i>New York City / Brooklyn</span> </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <div class="pro-content">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="pro-location hidden-xs hidden-xs"> <span class="pull-right text-muted"><i class="fa fa-map-marker text-danger m-r-10" aria-hidden="true"></i>New York City / Brooklyn</span> </div>
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            ...
                            <div class="col-sm-8">
                                <div class="pro-content">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="pro-location hidden-xs"> <span class="pull-right text-muted"><i class="fa fa-map-marker text-danger m-r-10" aria-hidden="true"></i>New York City / Brooklyn</span> </div>
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix"></div>
