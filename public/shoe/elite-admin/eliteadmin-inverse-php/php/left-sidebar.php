...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li> <a href="javascript:void(0);" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu"> Real Estate <span class="fa arrow"></span> <span class="label label-rouded label-custom pull-right">4</span></span></a>
                <ul class="nav nav-second-level">
                    <li> <a href="real-estate-dashboard.php">Dashboard</a> </li>
                    <li> <a href="property-list.php">Property List</a> </li>
                    <li> <a href="property-3-column.php">Property 3 Column</a> </li>
                    <li> <a href="property-4-column.php">Property 4 Column</a> </li>
                    <li> <a href="property-detail.php">Property Details</a> </li>
