...
<div class="container">
    ...
    <ul class="bannerchild">
        <li class="child1"><img src="images/full_braker_drive.jpg"/></li>
    </ul>
    <div class="breakertheme">
        <h2>เลือก Breaker Futsal ของคุณ</h2>
        <ul>
            <li><img src="images/oblique_drive_01.png"/><br>Breaker Drive</li>
            <li><img src="images/oblique_drive_02.png"/><br>Breaker Drive</li>
        </ul>
    </div><!-- .breakertheme -->
</div><!-- .container -->
